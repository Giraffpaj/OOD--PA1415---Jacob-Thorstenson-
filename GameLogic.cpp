...
void GameLogic::clearAll()
{
	delete this->myButtonListener;
	delete this->myDrawHandler;
	delete this->myMovementHandler;
	delete this->myEvents;
	delete this->myLibrary;
	delete this->myMapGenerator;
}
